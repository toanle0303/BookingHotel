...
const CreateListing = () => {
  ...
  // Upload, drag, and drop, remove photo
...
const handlePost = async (e) => {
  ...
  try{
    ...
    // Append each selected photos to the form data
      ...
      <div className="create-listing">
        ...
        <form onSubmit={handlePost}>
          <div className="create-listing_step1">
            ...
            <div className="half">
              <div className="location">
                ...
                <input
                  type="text"
                  placeholder="Apt, Suite, etc. (if.application)"
                  name="aptSuite"
            ...
            <div className="basics">
              <div className="basic">
                ...
                <div className="basic count">
                  <RemoveCircleOutline
                    onClick={() => {
                      guestsCount > 1 && setGuestCount(guestsCount - 1);
                    }}
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
          ...
          <div className="create-listing_step2">
            ...
            <h3>Add some photo of your place.</h3>
